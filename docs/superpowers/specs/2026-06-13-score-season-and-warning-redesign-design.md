...
3. **총력전 5980 경계**: 입력 그대로 사용. `5000~5980 / 6000~`(5980~6000 사이는 의도된 빈 구간).
...
- 총력전 경계: `~4000 / 4000~5000 / 5000~5980 / 6000~`
  - 셋째 구간은 5000~5980(상한 포함), 넷째는 6000~. 5981~5999는 의도된 빈 구간으로 어느 버킷에도 속하지 않음(실제 발생 거의 없음). 균등 단위가 아니므로 경계는 명시적 배열로 정의.
